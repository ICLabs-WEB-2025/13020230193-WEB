...
<head>
    <meta charset="UTF-8">
    <title>Daftar Buyer | KPR Properti</title>
...
<body>
    ...
    <div class="card register-card animate-fade-in">
        <div class="card-body p-4">
            <h4 class="text-center mb-3">Daftar sebagai <span class="text-success">Buyer</span></h4>
            ...
            <form method="POST" action="{{ url('/register/buyer') }}">
                @csrf
